 ...
 * @author VAIO
 */
public class CashierViewSales extends javax.swing.JFrame {

    /**
     * Creates new form CashierViewSales
     */
    public CashierViewSales() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Sales Today");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierViewSales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashierViewSales().setVisible(true);
            }
        });
    }
